...
```{r echo=FALSE, fig.cap="<https://www.youtube.com/watch?v=I6Y0HAjLKYI>"}
knitr::include_graphics("../liburua/images/paste-5.png")
```
...
Etorinek hainbat egoerari aurre egin behar diete: [es Vs ko](https://www.youtube.com/watch?v=Z1PduFLoJ0Y)
...
## Ariketa: Gela hirueleduna {data-background="#FE2E9A"}
