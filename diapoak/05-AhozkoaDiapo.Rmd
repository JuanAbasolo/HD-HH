---
title: "Ahozko hizkuntza Haur Hezkuntzan"
...
<!--# Berrantolatu apunteetan oinarrituta (M. Huarte & Ozenrinjauregi, SBD...)-->
...
```{r echo=FALSE}
knitr::include_graphics("../liburua/images/paste-4.png")
```
...
```{dot echo=FALSE, fig.cap="Ahozkoa eta idatzia continuumtzat", out.width="90%", fig.align='center'}
//| label: fig-5-2a
...
<!-- ![](../liburua/assets/5-2.png) bazpada -->
...
Hezkuntza-egoeren ekarpena umearen hizkuntzaren garapenerako: landu daitezkeen alderdi linguistiko eta komunikatiboak (adibideak)
...
```{r echo=FALSE}
knitr::include_graphics("../liburua/images/paste-2.png")
```
...
# Egitekoa {data-background="#FE2E9A"}
...
-   Proiektuak analizatu eta txostena prestatu  
    <small>Proiektuok irakasleari eskatu</small>
